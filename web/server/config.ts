...
export const BUDGETS = {
  ...
  review: parseFloat(process.env.DEFAULT_REVIEW_BUDGET || '1.50'),
...
export const MODELS = {
  ...
  reviewer: process.env.REVIEWER_MODEL || 'sonnet',
  researcher: process.env.RESEARCHER_MODEL || 'haiku',
  tester: process.env.TESTER_MODEL || 'haiku',
} as const;
...
export const DEFAULT_IMPLEMENTER_COUNT = parseInt(process.env.IMPLEMENTER_COUNT || '2', 10);

// --- Implementer Identities ---
export const IMPLEMENTER_POOL = [
  { id: 'implementer-1', name: 'Atlas', avatar: '/avatars/atlas.svg', color: '#3B82F6' },
  { id: 'implementer-2', name: 'Nova', avatar: '/avatars/nova.svg', color: '#8B5CF6' },
  { id: 'implementer-3', name: 'Bolt', avatar: '/avatars/bolt.svg', color: '#F59E0B' },
  { id: 'implementer-4', name: 'Sage', avatar: '/avatars/sage.svg', color: '#10B981' },
  { id: 'implementer-5', name: 'Flux', avatar: '/avatars/flux.svg', color: '#EF4444' },
] as const;
