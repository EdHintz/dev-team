...
# --- Budget Defaults (USD) ---
DEFAULT_PLAN_BUDGET="${DEFAULT_PLAN_BUDGET:-3.00}"
DEFAULT_RESEARCH_BUDGET="${DEFAULT_RESEARCH_BUDGET:-1.50}"
DEFAULT_TASK_BUDGET="${DEFAULT_TASK_BUDGET:-6.00}"
DEFAULT_REVIEW_BUDGET="${DEFAULT_REVIEW_BUDGET:-1.50}"
DEFAULT_TEST_BUDGET="${DEFAULT_TEST_BUDGET:-3.00}"

# --- Model Selection ---
PLANNER_MODEL="${PLANNER_MODEL:-opus}"
DEVELOPER_MODEL="${DEVELOPER_MODEL:-opus}"
REVIEWER_MODEL="${REVIEWER_MODEL:-opus}"
RESEARCHER_MODEL="${RESEARCHER_MODEL:-opus}"
